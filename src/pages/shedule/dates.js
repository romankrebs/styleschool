export const dates = {
  ...
  designInterior: {
    online: new Date(2020, 5, 15),
    ofline: new Date(2020, 8, 24)
  },
  // Дизайн интерьера, интенсив
  interiorDesign: new Date(2020, 3, 28),
  // Декорирование интерьеров, интенсив
  interiorDecor: {
    online: new Date(2020, 5, 8)
  },
  ...
  imagemaker: {
    online: new Date(2020, 5, 17),
    ofline: new Date(2020, 5, 13),
