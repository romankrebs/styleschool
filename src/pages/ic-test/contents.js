...
// import Spoler2 from "./spoler-new";
// import Spoler from "../../components/spoler";
// import Revew from "../../patterns/pattern-fs/revew";
...
export const contents = {
  ...
  head: {
    ...
    head: (
      ...
      >
        Индивидуальный стиль: карьера, бизнес, профессия
      </div>
    ),
    headAfterDescript:
      "Обучение по программе «Имидж-консалтинг индивидуальный стиль»",
    descript: [
      "Очно, дистанционно",
    ...
    text: (
      <List
        arr={[
          ...
          "Если хотите, сделайте имидж-консультирование своей профессией"
        ]}
      />
    ),
    video: "rYKZAsSnC84"
  ...
  aboutProfeshion: {
    title: "Об индивидуальном стиле и компетенциях в имидж-консалтинге",
    short:
