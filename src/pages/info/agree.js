          ...
          <Paragraph
            content={[
              ...
              <span>
                ...
                Интернет-портале в разделе «Информация для покупателей». Порядок
                и условия оплаты с использованием платежных систем определяются
                платежными системами. С условиями Клиент может ознакомиться на
                сайтах платежных систем, а также получить по электронной почте
                по запросу в службу технической поддержки{" "}
              ...
              <span>
                6.2.6. Школа не несет ответственности за предоставление Клиентом
                неправильной контактной информации (адресов электронной почты,
                телефонов). При неполучении ответа от Клиента (невозможности
                связаться по телефону, неполучении ответа по электронной почте
                или через личный кабинет), Школа вправе выполнить свое
                обязательство по предложению Клиенту вариантов времени и даты
                оказания Услуг, направив соответствующие предложения в Личный
                кабинет Клиента. Направленные предложения действительны (могут
                быть приняты Клиентом) в течение семи календарных дней, не
                считая день отправления. О принятии предложений Клиент обязан
                сообщить Школе, направив подтверждение на адрес технической
                поддержки{" "}
                <a href="mailto:info@styleschool.ru">info@styleschool.ru</a>
              </span>,
