...
export const contents = {
  ...
  text1: (
    <span>
      ...
      <br />
      Тем, кто только планирует построить карьеру в индустрии моды, кто желает
      поменять направление своей деятельности и сделать это правильно, освоиф
      профессиональные навыки и компетенции, даже параллельно с работой, получит
      интересную специальность и сможет действовать профессионально и
      рационально.
    </span>
  ),
  tags1: (
    <span>
      теги: {/* <a href="#programma"> */}
      <span style={{ color: "rgb(180,180,180)" }}>#fashionretail&ensp;</span>
      {/* </a>{" "}
      <a href="#profession"> */}
      <span style={{ color: "rgb(180,180,180)" }}>#ВМ&ensp;</span>
      {/* </a>{" "}
      <a href="#teachers"> */}
      <span style={{ color: "rgb(180,180,180)" }}>#магазинодежды&ensp;</span>
      {/* </a>{" "}
      <a href="#review"> */}
      <span style={{ color: "rgb(180,180,180)" }}>#карьерамерчендайзинг</span>
      {/* </a> */}
    </span>
  ),
  screen2: {
    ...
    content: [
      ...
      <List
        ...
        arr={[
          ...
          <List
            style={styles.p}
            arr={["Photoshop", "Archikad", "Power Point"]}
          />,
