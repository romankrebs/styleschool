      ...
      <Grid container justify="center" alignItems="flex-start">
        <Grid item xs={12} md={12}>
          <Teacher
            ...
            short={
              <span>Писатель, преподаватель (письмо, пиар), психотерапевт</span>
            }
                  ...
                  <List
                    arr={[
                      ...
                      <span>
                        ...
                        особенности. Законы, приёмы, условные парадигмы. Ремесло
                        блогера как стиль жизни. Чистая подача мысли. Выразить
                        себя через письмо.
                      </span>
                    ]}
                  />
