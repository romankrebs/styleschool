...
export const contents = {
  ...
  head: {
    ...
    descript: [
      ...
      "9 месяцев, 360 академических часа",
      "Рассрочка, налоговый вычет",
      "От 9900 руб. в месяц"
    ],
    text: "",
    imageComment: false,
    imageSource: "/img/living-interior-design-and-decoration/fullscreen.jpg",
    styleImage: {
      height: 300,
      maxWidth: "auto"
    },
  ...
  aboutProfeshion: {
    ...
    detail: [
      <Paragraph
        style={styles.p}
        content={["Очень пафосный текст о профессии…."]}
      />
    ]
  },
  principes: [
  ...
  programma: {
    ...
    content: [
      <List
        ...
        arr={[
          "Обучение делится на 4 уровня. Каждый уровень содержит \
          практические блоки, где студенты закрепляют полученные знания \
          и навыки, используя профессиональные инструменты и профильн\
          ые компьютерные программы. Оценкой полученных знаний и навыко\
          в являются промежуточное тестирование и дипломная работа.",
      ...
      <List
        ...
        arr={[
          ...
          "2D-моделирование: photoshop и archikad",
          ...
          "Коммуникации: специфика работы дизайнера или как найти \
          баланс с самим собой, клиентом, подрядчиком и строителями"
        ]}
      />,
      <h2
        style={{
      ...
      <List
        ...
        olStyle={{ marginLeft: 0, paddingLeft: 0 }}
        arr={[
          "Защита итоговой работы и подтверждение дипломом изученных \
          компетенций",
  ...
  teachers: [
    ...
    },
    {
      ...
      text:
        "Практикующий дизайнер и декоратор. Член Международного Союза дизайнеров.",
      instagram: false,
      buttons: {
